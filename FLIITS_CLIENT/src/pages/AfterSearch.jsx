...
function AfterSearch() {
  ...
  useEffect(() => {
    ...
    const fetchCarData = async () => {
      try {
        const response = await axios.post("/api/mainSearch", {
          destination: searchParams.location, // Map "location" to "destination"
    ...
    <div className="AfterSearch-container">
      ...
      <div className="search-Container">
        <div className="search-params">
          ...
          <p>
            <label>Start Date:</label> {searchParams.startDate}
          </p>
          <p>
            <label>End Date:</label> {searchParams.endDate}
          </p>
          <p>
            <label>Start Time:</label> {searchParams.startTime}
          </p>
          <p>
            <label>End Time:</label> {searchParams.endTime}
          </p>
        </div>
      </div>
